    ...
    $(document).ready(function () {
        ...
        allNextBtn.click(function () {
            var curStep = $(this).closest(".setup-content"),
                ...
                curInputs = curStep.find("input[type='text'],input[type='url'],input[type='email'],input[type='textarea']"),
                isValid = true;
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-sm-6" style="margin-top: 3%;">
                                <div class="form-group">
                                    ...
                                    <div class="checkbox-inline">
                                        <input type="text" placeholder="Others" name="other">
                                    </div>
                                ...
                                <div class="col-sm-6" style="font-size: 13px;">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" name="face_id" value="working" checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="face_id" value="not_working">not Working
                                            </label>
                                    <br/><hr/>
                                            Home Button
                                            <label class="radio-inline">
                                                <input type="radio" name="home_button" value="working" checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="home_button" value="not_working">not
                                                Working
                                            </label>
                                    <br/><hr/>
                                            Microphone
                                            <label class="radio-inline">
                                                <input type="radio" name="microphone" value="working" checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="microphone" value="not_working">not
                                                Working
                                            </label>
                                    <br/><hr/>
                                            Ear Speaker
                                            <label class="radio-inline">
                                                <input type="radio" name="earphone" value="working" checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="earphone" value="not_working">not Working
                                            </label>
                                    <br/><hr/>
                                            Ringtone/Loud Speaker
                                            <label class="radio-inline">
                                                <input type="radio" name="ringtone_loudspeaker" value="working"
                                                       checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="ringtone_loudspeaker" value="not_working">not
                                                Working
                                            </label>
                                    <br/><hr/>
                                            Volume Control
                                            <label class="radio-inline">
                                                <input type="radio" name="volume_control" value="working" checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="volume_control" value="not_working">not
                                                Working
                                            </label>
                                    <br/><hr/>
                                            Power Button
                                            <label class="radio-inline">
                                                <input type="radio" name="power_button" value="working" checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="power_button" value="not_working">not
                                                Working
                                            </label>
                                    <br/><hr/>
                                            Charging Port/Data Port
                                            <label class="radio-inline">
                                                <input type="radio" name="charging_port" value="working" checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="charging_port" value="not_working">not
                                                Working
                                            </label>
                                    <br/><hr/>
                                            Rear Glass
                                            <label class="radio-inline">
                                                <input type="radio" name="rear_glass" value="working" checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="rear_glass" value="not_working">not
                                                Working
                                            </label>
                                    <br/><hr/>
                                            Rear Camera
                                            <label class="radio-inline">
                                                <input type="radio" name="rear_camera" value="working" checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="rear_camera" value="not_working">not
                                                Working
                                            </label>
                                    <br/><hr/>
                                            Front Camera
                                            <label class="radio-inline">
                                                <input type="radio" name="front_camera" value="working" checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="front_camera" value="not_working">not
                                                Working
                                            </label>
                                    <br/><hr/>
                                            Silent Mode Switch
                                            <label class="radio-inline">
                                                <input type="radio" name="silent_mode_switch" value="working"
                                                       checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="silent_mode_switch" value="not_working">not
                                                Working
                                            </label>
                                    <br/><hr/>
                                            Wi-Fi
                                            <label class="radio-inline">
                                                <input type="radio" name="wifi" value="working" checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="wifi" value="not_working">not Working
                                            </label>
                                    <br/><hr/>
                                    Cell Signal
                                    <label class="radio-inline">
                                        <input type="radio" name="cell_signal" value="working" checked>Working
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="cell_signal" value="not_working">not
                                        Working
                                    </label>
                                    <br/><hr/>
                                </div>
                                <div class="col-sm-6" style="font-size: 13px;">
                                            Battery Health
                                            <label class="radio-inline">
                                                <input type="radio" name="battery_health" value="working" checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="battery_health" value="not_working">not
                                                Working
                                            </label>
                                    <br/><hr/>
                                            Sim Card Reader
                                            <label class="radio-inline">
                                                <input type="radio" name="sim_card_reader" value="working" checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="sim_card_reader" value="not_working">not
                                                Working
                                            </label>
                                    <br/><hr/>
                                            Card/SD Card Slot
                                            <label class="radio-inline">
                                                <input type="radio" name="memory_card" value="working" checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="memory_card" value="not_working">not
                                                Working
                                            </label>
                                    <br/><hr/>
                                            Headset Jack
                                            <label class="radio-inline">
                                                <input type="radio" name="headset_jack" value="working" checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="headset_jack" value="not_working">not
                                                Working
                                            </label>
                                    <br/><hr/>
                                            Proximity Sensor
                                            <small style="font-size: 10px">(allow the display to shut on or off
                                                when on
                                                a call)
                                            </small>
                                            <label class="radio-inline">
                                                <input type="radio" name="proximity_sensor" value="working"
                                                       checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="proximity_sensor" value="not_working">not
                                                Working
                                            </label>
                                    <br/><hr/>
                                            Missing screws
                                            <label class="radio-inline">
                                                <input type="radio" name="missing_screws" value="yes" checked>Yes
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="missing_screws" value="no">No
                                            </label>
                                    <br/><hr/>
                                            Vibrator
                                            <label class="radio-inline">
                                                <input type="radio" name="vibrator" value="working" checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="vibrator" value="not_working">not Working
                                            </label>
                                    <br/><hr/>
                                            Battery Connector
                                            <label class="radio-inline">
                                                <input type="radio" name="battery_connector" value="working"
                                                       checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="battery_connector" value="not_working">not
                                                Working
                                            </label>
                                    <br/><hr/>
                                            Bluetooth
                                            <label class="radio-inline">
                                                <input type="radio" name="bluetooth" value="working" checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="bluetooth" value="not_working">not Working
                                            </label>
                                    <br/><hr/>
                                            Internet
                                            <label class="radio-inline">
                                                <input type="radio" name="internet" value="working" checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="internet" value="not_working">not Working
                                            </label>
                                    <br/><hr/>
                                            BatteryAntenna
                                            <small>(Signal)</small>
                                            <label class="radio-inline">
                                                <input type="radio" name="antenna" value="working" checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="antenna" value="not_working">not Working
                                            </label>
                                    <br/><hr/>
                                            All Buttons
                                            <small>(Domes or Switches)</small><br/>
                                            <label class="radio-inline">
                                                <input type="radio" name="buttons" value="working" checked>Working
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="buttons" value="not_working">not Working
                                            </label>
                                    <br/><hr/>
                                            Device has no power and can not test
                                            <input type="checkbox" name="device_checked">
                                    <br/><hr/>
                                </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                            ...
                            <button class="btn btn-primary nextBtn pull-right" type="button">Next <span
                                    class="glyphicon glyphicon-arrow-right"></span></button><br/>
                        </div>
                    </div>
