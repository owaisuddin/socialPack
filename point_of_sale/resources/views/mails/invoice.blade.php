                    ...
                    <div class="row">
                        <div class="col">
                            <a target="_blank" href="http://fxitright.com">
                                <img src="{{ url('/public/certified3.jpg') }}" width="300px" height="130px" data-holder-rendered="true"  alt="FXitRight Logo"/>
                            </a>
                        </div>
                ...
                <main>
                    ...
                    <div class="thanks">
                        Thank you for trusting FXitRight with your gadget. We will persist until we succeed.
                                        ...
                                        <div class="notices">
                                            <div>NOTICE:</div>
                                            <div class="notice">Warranty should be 60 days.
                                                Warranty does not cover <b style="color: red;">physical or water damage</b>. Your screen can also be damaged from the inside and the outside not cracked and this will not be covered under warranty. If your battery is going bad it lets out gas in which the battery will enlarge and cause the screen to crack or go black and this will not be covered under warranty.</div>
                                        </div>
                </main>
                <footer>
