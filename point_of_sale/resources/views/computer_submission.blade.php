                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" name="unit_reloaded" value="working" checked>Working
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="unit_reloaded" value="not_working">not Working
                                    </label>
                                    <br/><hr/>
                                    Optical Drive
                                    <label class="radio-inline">
                                        <input type="radio" name="optical_drive" value="working" checked>Working
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="optical_drive" value="not_working">not Working
                                    </label>
                                    <br/><hr/>
                                    Heatsink
                                    <label class="radio-inline">
                                        <input type="radio" name="heatsink" value="working" checked>Working
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="heatsink" value="not_working">not Working
                                    </label>
                                    <br/><hr/>
                                    TouchPad
                                    <label class="radio-inline">
                                        <input type="radio" name="touchpad" value="working" checked>Working
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="touchpad" value="not_working">not Working
                                    </label>
                                    <br/><hr/>
                                    LCD
                                    <label class="radio-inline">
                                        <input type="radio" name="lcd" value="working" checked>Working
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="lcd" value="not_working">not Working
                                    </label>
                                    <br/><hr/>
                                    AC Adapter
                                    <label class="radio-inline">
                                        <input type="radio" name="ac_adapter" value="working" checked>Working
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="ac_adapter" value="not_working">not Working
                                    </label>
                                    <br/><hr/>
                                    System Board
                                    <label class="radio-inline">
                                        <input type="radio" name="system_board" value="working" checked>Working
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="system_board" value="not_working">not Working
                                    </label>
                                    <br/><hr/>
                                    CPU
                                    <label class="radio-inline">
                                        <input type="radio" name="cpu" value="working" checked>Working
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="cpu" value="not_working">not Working
                                    </label>
                                    <br/><hr/>
                                </div>
                                <div class="col-sm-6">
                                    Mouse
                                    <label class="radio-inline">
                                        <input type="radio" name="mouse" value="working" checked>Working
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="mouse" value="not_working" >not Working
                                    </label>
                                    <br/><hr/>
                                    Hinge
                                    <label class="radio-inline">
                                        <input type="radio" name="hinge" value="working" checked>Working
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="hinge" value="not_working">not Working
                                    </label>
                                    <br/><hr/>
                                    Hard Drive
                                    <label class="radio-inline">
                                        <input type="radio" name="hard_drive" value="working" checked>Working
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="hard_drive" value="not_working">not Working
                                    </label>
                                    <br/><hr/>
                                    RAM Memory
                                    <label class="radio-inline">
                                        <input type="radio" name="ram_memory" value="working" checked>Working
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="ram_memory" value="not_working">not Working
                                    </label>
                                    <br/><hr/>
                                    Keyboard
                                    <label class="radio-inline">
                                        <input type="radio" name="keyboard" value="working" checked>Working
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="keyboard" value="not_working">not Working
                                    </label>
                                    <br/><hr/>
                                    Fan
                                    <label class="radio-inline">
                                        <input type="radio" name="fan" value="working" checked>Working
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="fan">not Working
                                    </label>
                                    <br/><hr/>
                                    Other's
